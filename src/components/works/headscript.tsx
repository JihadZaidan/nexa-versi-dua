    ...
    return (
        <div className="max-w-full w-full bg-neutral-100 lg:px-20 lg:pt-16 lg:pb-20 px-8 pt-6 pb-14">
            <div className="w-full flex flex-col lg:gap-25 gap-16">
                <h1 className="font-sans font-medium text-left lg:text-7xl text-4xl text-neutral-800 leading-[130%]">Check Our <br /> Works</h1>
                <p className="font-sans font-medium lg:text-right lg:w-full lg:text-3xl text-lg text-neutral-800 leading-[150%]">
